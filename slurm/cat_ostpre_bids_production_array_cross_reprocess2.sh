...
#SBATCH --output /research/users/justoh/slurm_logs/ostpre_cat_logs/ostpre_re3_%A_%a.err    # Standard output goes to here
#SBATCH --error  /research/users/justoh/slurm_logs/ostpre_cat_logs/ostpre_re3_%A_%a.out    # Standard error goes to here
...
SUBJ=$(sed -n "$ROWINDEX"p ${BIDSDIR}/reprocess_cross2.txt)
